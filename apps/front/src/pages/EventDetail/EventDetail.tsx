      ...
      <div className="event-detail__content">
        ...
        <div className="event-detail__info-grid">
          <div className="event-detail__info-item">
            <h3>Date et heure</h3>
            <p>{new Date(event.date).toLocaleString("fr-FR", { timeZone: "UTC" })}</p>
          </div>
          ...
          <div className="event-detail__info-item">
            <h3>Joueurs</h3>
            <p>{event.characters?.length || 0} / {event.max_players}</p>
          </div>
          ...
          {event.server && (
            <div className="event-detail__info-item">
              <h3>Serveur</h3>
              <p>{event.server.name} {event.server.mono_account ? "(Mono-compte)" : ""}</p>
            </div>
          )}
