...
const Admin: React.FC = () => {
  ...
  const filteredEvents = events.filter(event => {
    ...
    const matchesSearch = event.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         ...
                         (event.user?.username.toLowerCase().includes(searchTerm.toLowerCase()) || false);
    ...
    <div className="admin-page">
      ...
      <div className="admin-controls">
        ...
        <div className="stats">
          ...
          <span className="stat">
            Affichés: {filteredEvents.length}
          </span>
        </div>
      </div>
              ...
              <tr key={event.id}>
                ...
                <td>
                  <div className="creator-info">
                    <span className="username">{event.user?.username || 'Inconnu'}</span>
                    <span className="user-role">{event.user?.role || 'user'}</span>
                  </div>
                </td>
                <td>
