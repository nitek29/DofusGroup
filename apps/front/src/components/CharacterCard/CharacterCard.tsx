    ...
    <div className="character_card">
      <div className="character_card_header">
        <h4 className="character_card_name">
          {character.name}
          {character.default_character && <span className="character_card_default">★</span>}
        </h4>
      ...
      <div className="character_card_details">
        ...
        <div className="character_card_info">
          ...
          <span className="character_card_value">
            {character.alignment === 'neutral' ? 'Neutre' : 
             character.alignment === 'bontarien' ? 'Bontarien' : 'Brakmarien'}
          </span>
        </div>
